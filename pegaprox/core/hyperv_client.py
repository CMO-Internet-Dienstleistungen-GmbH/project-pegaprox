...
class HyperVPowerShellClient:
    ...
    def run_action(self, script: str, description: str) -> Any:
...
class PsrpHyperVClient(HyperVPowerShellClient):
    ...
    def _invoke(self, script: str, context: str) -> Any:
    ...
    def run_json(self, script: str) -> Any:
        ...
        return self._invoke(script, 'reading from the host')
    ...
    def run_action(self, script: str, description: str) -> Any:
        ...
        return self._invoke(script, description)
